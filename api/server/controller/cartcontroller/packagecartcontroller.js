...
//let PackageCartDb = require('../../model/checkoutmodel/packagecheckoutmodel');
let PackageCartDb = require('../../model/cartmodel/packagecartmodel');
...
exports.update = (req, res) => {
    ...
    PackageCartDb.findByIdAndUpdate(id, req.body,{useFindAndModify: false})
    .then(data => {
        if(!data){
...
exports.delete = (req, res) => {
    ...
    const id = req.params.id
    PackageCartDb.findByIdAndDelete(id)
    .then(data => {
        if(!data){
            res.status(404).send({message: "can not find user"})
        }else{
